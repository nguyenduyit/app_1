...
public class MyPostFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerMyPost.setHasFixedSize(true);

        recyclerMyPost.setLayoutManager(new LinearLayoutManager(getActivity()));

        db= FirebaseFirestore.getInstance();
        postArrayList = new ArrayList<Post>();
        myPostAdapter = new MyPostAdapter(getActivity(),postArrayList);

        recyclerMyPost.setAdapter(myPostAdapter);
        EventChangeListener();
        return view;
    }
